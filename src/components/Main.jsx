...
const Main = ({visiable, setVisiable}) => {
  return (
    <div className={`p-5 w-full flex   flex-col ${visiable?"ml-40":"ml-20"}`}>
      ...
      <main className="lg:mx-50 mt-20 ">
        ...
        <section className="grid grid-cols-2  lg:grid-cols-4  mt-10  ">
         ...
         <div className="bg-gray-200 m-2 p-4 min-h-[200px] flex flex-col rounded-2xl justify-between hover:bg-gray-300 transition-all duration-200 cursor-pointer">
            ...
            <div>
              <img src={compass} alt="" className="w-6 justify-self-end   bg-white rounded-4xl " />
            </div>
          </div>
           ...
           <div className="bg-gray-200 m-2 p-4 min-h-[200px] flex flex-col rounded-2xl justify-between hover:bg-gray-300 transition-all duration-200 cursor-pointer">
            ...
            <div>
              <img src={bulb} alt="" className="w-6 justify-self-end   bg-white rounded-4xl " />
            </div>
          </div>
           ...
           <div className="bg-gray-200 m-2 p-4 min-h-[200px] flex flex-col rounded-2xl justify-between hover:bg-gray-300 transition-all duration-200 cursor-pointer">
            ...
            <div>
              <img src={message} alt="" className="w-6 justify-self-end   bg-white rounded-4xl " />
            </div>
          </div>
           <div className="bg-gray-200 m-2 p-4 min-h-[200px] flex flex-col rounded-2xl justify-between hover:bg-gray-300 transition-all duration-200 cursor-pointer">
            <p>Tell me about React js and React native</p>
            <div>
              <img src={code} alt="" className="w-6 justify-self-end bg-white rounded-4xl  " />
            </div>
          </div>
        </section>
        <section className="w-full bg-gray-200 rounded-4xl p-5 flex justify-between gap-4 ">
          <input type="text" placeholder="Enter a prompt here" className="w-full outline-none"/>
        <div className="flex gap-1"> 
            <img src={gallery} alt="" className="w-8 cursor-pointer bg-white rounded-4xl items-center justify-center p-1 " />
              <img src={mic} alt="" className="w-8 cursor-pointer bg-white rounded-4xl items-center justify-center p-1 "  />
                 <img src={send} alt="" className="w-8 cursor-pointer bg-white rounded-4xl items-center justify-center p-1 "  />
        </div>
         
        </section>
        <p className="text-gray-800 text-sm text-center mt-2">Gemini may display inaccurate info, including about people, so double-check its responses. Your privacy and Gemini Apps</p>
      </main>
    </div>
  );
};
